...
[![Build Status](https://travis-ci.com/imsweb/staging-algorithm-cs.svg?branch=master)](https://travis-ci.com/imsweb/staging-algorithm-cs)
...
```groovy
compile 'com.imsweb.com:staging-algorithm-cs:02.05.50.2'
```
